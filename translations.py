...
class Translations:
    ...
    EN = {
        ...
        "column_index_url": "Column index for URL:",
        "column_index_url_tooltip": "Column index (0-based) where URLs are located. -1 = check all cells",
        "column_index_url_hint": "(-1 = all cells, 0 = first column, 1 = second, etc.)",
        "not_used": "Not used",
        "check_all_cells": "Check all cells",
    ...
    RU = {
        ...
        "column_index_url": "Индекс колонки для URL:",
        "column_index_url_tooltip": "Индекс колонки (начиная с 0), где находятся URL-ссылки. -1 = проверять все ячейки",
        "column_index_url_hint": "(-1 = все ячейки, 0 = первая колонка, 1 = вторая и т.д.)",
        "not_used": "Не используется",
        "check_all_cells": "Проверять все ячейки",
